...
import { grass } from "@standard-reader/design-system/theme/colors/grass.stylex";
import { indigo } from "@standard-reader/design-system/theme/colors/indigo.stylex";
import {
  mauve,
  mauveInverted,
} from "@standard-reader/design-system/theme/colors/mauve.stylex";
import { plum } from "@standard-reader/design-system/theme/colors/plum.stylex";
import {
  sage,
  sageInverted,
} from "@standard-reader/design-system/theme/colors/sage.stylex";
import {
  sand,
  sandInverted,
} from "@standard-reader/design-system/theme/colors/sand.stylex";
import {
  slate,
  slateInverted,
} from "@standard-reader/design-system/theme/colors/slate.stylex";
import { teal } from "@standard-reader/design-system/theme/colors/teal.stylex";
import { tomato } from "@standard-reader/design-system/theme/colors/tomato.stylex";
