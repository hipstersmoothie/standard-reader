...
function Settings() {
  ...
  return (
    <div style={{ height: "100%", overflow: "auto", background: C.pageBg }}>
      <div style={{ maxWidth: 760, margin: "0 auto", padding: "44px 40px 90px" }}>
        <h1
          style={{
            fontFamily: C.serif,
            fontWeight: 500,
        ...
        <div>
          ...
          <div style={{ borderBottom: `1px solid ${C.b6}` }}>
            ...
            <Row label="Links / unsubscribe" value={data.sending.publicUrl} mono />
            <Row
              label="Resend"
              value={
                <span
          ...
          <p style={{ fontSize: 13, color: C.mut, marginTop: 16, lineHeight: 1.6 }}>
