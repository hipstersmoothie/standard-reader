  ...
  plugins: [
    stylexPlugin({
      ...
      aliases: {
        ...
        // StyleX has to compile the shared publication theme too: its `tokens`
        // module is a `stylex.createTheme` over the design system's tokens, and
        // an uncompiled `stylex.create` call throws at runtime.
