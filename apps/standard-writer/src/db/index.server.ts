...
export type StandardDb = NodePgDatabase<typeof schema>;

let cached: StandardDb | null | undefined;

function create(): StandardDb | null {
  ...
  if (isNeon) {
    return drizzleHttp(neon(url), { schema }) as unknown as StandardDb;
  }
...
export function getDb(): StandardDb | null {
