...
export function Delta({
  ...
  return (
    <span
      {...stylex.props(styles.delta, good ? styles.deltaUp : styles.deltaDown)}
    >
...
export function StatCard({
  ...
  if (to === undefined) {
    return <div {...stylex.props(common.card, styles.statCard)}>{body}</div>;
  }
  return (
    <Link
      to={to}
...
export function BigStat({
  ...
  return (
    <div {...stylex.props(styles.bigStat)}>
      ...
      <div {...stylex.props(styles.bigStatValue, tone && STAT_TONE[tone])}>
        {value}
      </div>
