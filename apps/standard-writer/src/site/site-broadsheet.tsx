...
import { siteDate, siteLongDate } from "#/lib/site/format";
 ...
 */
export function SiteBroadsheet({ page, articles, olderHref }: SiteViewProps) {
        ...
        <div {...stylex.props(styles.dateline)}>
          ...
          <span>
            {masthead.lastPublishedAt
              ? siteLongDate(masthead.lastPublishedAt)
              : null}
          </span>
        </div>
